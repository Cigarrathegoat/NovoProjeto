package br.com.homework.applicant.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.homework.applicant"))
    ...
    private StringBuilder buildDescription() {
        ...
        text.append("Documento de API para inserir e catalogar aplicantes.");
